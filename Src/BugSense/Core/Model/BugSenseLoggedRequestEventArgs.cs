...
// Type: BugSense.Core.Model.BugSenseLoggedRequestEventArgs
...
{
  public class BugSenseLoggedRequestEventArgs : EventArgs
  {
    public BugSenseResponseResult BugSenseLoggedResponseResult { get; set; }
  }
}
