...
// Type: BugSense.Core.Model.SyncContextExceptionDelegate
...
{
  internal delegate void SyncContextExceptionDelegate(
    SyncContextExceptionEventArgs syncContextException,
    BugSenseLogResult logResult);
}
