    ...
    public sealed partial class Login : Page
    {
        ...
        public Login()
        {
            try
            {
                ...
                if (!ServerConnectionManager.mIsDebug)
                    return;
                ((UIElement)this.Choose_Server).Visibility = Visibility.Visible;
            }
            catch
            {
            }
        ...
        private void SetAppVersion()
        {
            try
            {
                ...
                if (ServerConnectionManager.mIsDebug)
                    this.AppVersion.Text = appVersion + Environment.NewLine 
                        + this.SCMobj.getServerNameAPI();
                else
        ...
        public async Task Feedback()
        {
            try
            {
                ...
                this.InTouchID_Text.Text = string.Empty;
            }
            catch (Exception ex)
            {
